...
<ul class="navbar-nav navbar-right">
    ...
    <a href="/select" class="nav-link nav-link-lg nav-link-user">
        <!-- <img alt="image" src="{{ asset('img/souichi.png') }}" class="rounded-circle mr-1 thumbnail-rounded user-thumbnail ">-->
        <div class="d-sm-none d-lg-inline-block">
            Ir a Razones Sociales</div>
    </a>
</ul>